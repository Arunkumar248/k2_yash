...
import com.lws.utilities.*;



public class AutomationMail extends AutomationBase {
	...
	public void sendMailReport() throws Exception {
		...
		final String userName = propertyObj.getProperty(AutomationConstants.EMAIL_CONFIG, "username");
		final String password = propertyObj.getProperty(AutomationConstants.EMAIL_CONFIG, "password");
